                                  ...
                                  supportedAppRights:(NSArray *)supportedAppRights;
{
    ...
    UIViewController *policyViewController = [[ResourcesUtilsUI storyboard] instantiateViewControllerWithIdentifier:kPolicyNavigator];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    dispatch_once(&onceToken, ^{
        permittedImage = [[UIImage alloc] initWithContentsOfFile:[[ResourcesUtilsUI frameworkBundle] pathForResource:kPermittedImageAsset ofType:kPNG]];
        restrictedImage = [[UIImage alloc] initWithContentsOfFile:[[ResourcesUtilsUI frameworkBundle] pathForResource:kRestrictedImageAsset ofType:kPNG]];
    });
