 ...
 *
 * FileName:     TemplatesViewController.m
 *
 */
...
{
    PolicyTemplateCell *cell = (PolicyTemplateCell *)[tableView dequeueReusableCellWithIdentifier:kDisplayCellID forIndexPath:indexPath];
...
{
    PolicyTemplateCell *policyCell = (PolicyTemplateCell *)cell;
...
{
    PolicyTemplateCell *cell = [tableView dequeueReusableCellWithIdentifier:kDisplayCellID];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PolicyTemplateCell *policyCell = (PolicyTemplateCell *)[tableView cellForRowAtIndexPath:indexPath];
    [self updateCellForDisplay:policyCell atIndexPath:indexPath];
}
...
- (void)updateCellForDisplay:(PolicyTemplateCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    MSTemplateDescriptor *template = [self.templates objectAtIndex:indexPath.row];
