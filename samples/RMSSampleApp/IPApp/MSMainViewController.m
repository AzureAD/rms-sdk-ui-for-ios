...
#import <MSRightsManagementUI/MSEmailInputDelegate.h>
                           ...
                           withCustomProtection:(BOOL)customProtection
{
    ...
    {
        self.protectionTypeSegmentedControl.selectedSegmentIndex = kCustomProtectedFileSelected;
    }
}
...
{
    self.stringEncoding = [MSStringEncodingUtils getStringEncoding:plainData];
